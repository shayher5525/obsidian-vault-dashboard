...
- **Sei temi** — Tech minimalista, Console Y2K, Casa del Caffè, Fast Food Pop, Scena nera e Cielo blu.
...
| Aspetto | Stile visivo: Tech minimalista, Console Y2K, Casa del Caffè, Fast Food Pop, Scena nera o Cielo blu. |
