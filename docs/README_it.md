...
- **Cinque temi** — Tech minimalista, Console Y2K, Casa del Caffè, Fast Food Pop e Scena nera.
...
| Aspetto | Stile visivo: Tech minimalista, Console Y2K, Casa del Caffè, Fast Food Pop o Scena nera. |
