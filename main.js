...
const APPEARANCE_IDS = ["modern", "y2k", "starbucks", "fastfood"];
...
const I18N = {
  "zh-Hans": {
    ...
    appearanceNames: { modern: "极简科技", y2k: "Y2K 控制台", starbucks: "咖啡屋", fastfood: "流行快餐" },
  ...
  "zh-Hant": {
    ...
    appearanceNames: { modern: "極簡科技", y2k: "Y2K 控制臺", starbucks: "咖啡屋", fastfood: "流行快餐" },
  ...
  en: {
    ...
    appearanceNames: { modern: "Minimal Tech", y2k: "Y2K Console", starbucks: "Coffee House", fastfood: "Pop Fast Food" },
  ...
  fr: {
    ...
    appearanceNames: { modern: "Tech minimaliste", y2k: "Console Y2K", starbucks: "Maison du Café", fastfood: "Fast Food Pop" },
    dashboardTitle: "Vault Dashboard X",
    tabOverview: "Aperçu",
    tabFolders: "Dossiers",
    tabAll: "Tout",
  ...
  it: {
    ...
    appearanceNames: { modern: "Tech minimalista", y2k: "Console Y2K", starbucks: "Casa del Caffè", fastfood: "Fast Food Pop" },
    dashboardTitle: "Vault Dashboard X",
  ...
  ja: {
    ...
    appearanceNames: { modern: "ミニマルテック", y2k: "Y2K コンソール", starbucks: "コーヒーハウス", fastfood: "ポップファストフード" },
    dashboardTitle: "Vault Dashboard X",
    tabOverview: "概要",
    tabFolders: "フォルダー",
    tabAll: "すべて",
  ...
  ko: {
    ...
    appearanceNames: { modern: "미니멀 테크", y2k: "Y2K 콘솔", starbucks: "커피 하우스", fastfood: "팝 패스트푸드" },
    dashboardTitle: "Vault Dashboard X",
    tabOverview: "개요",
    tabFolders: "폴더",
    tabAll: "전체",
  ...
  es: {
    ...
    appearanceNames: { modern: "Tech minimalista", y2k: "Consola Y2K", starbucks: "Casa del Café", fastfood: "Fast Food Pop" },
    dashboardTitle: "Vault Dashboard X",
    tabOverview: "Resumen",
    tabFolders: "Carpetas",
    tabAll: "Todo",
